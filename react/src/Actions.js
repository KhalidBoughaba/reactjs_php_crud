...
export const Actions = () => {
  ...
  useEffect(() => {
    fetch("http://localhost/reactjs_php_crud/crud_php/all-users.php")
      .then((res) => {
        return res.json();
      })
      .then((data) => {
  ...
  const insertUser = (newUser) => {
    fetch("http://localhost/reactjs_php_crud/crud_php/add-user.php", {
      method: "POST",
      headers: {
  ...
  const updateUser = (userData) => {
    fetch(
      "http://localhost/reactjs_php_crud/crud_php/update-user.php",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  const deleteUser = (theID) => {
    ...
    fetch(
      "http://localhost/reactjs_php_crud/crud_php/delete-user.php",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
