...
/>
                ...
                <a href="#" style="display: flex; justify-content: center;">forget passeword</a>
                <p style="color: #00000087;display: flex; justify-content: space-around;">Don't Have an account!<a href="#" style="color: #6c63ff;">SignUp</a></p>
            </form>
        </div>
    </div>
